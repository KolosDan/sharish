        ...
        <View activePanel="new-user" id="view4">
          <Panel id="new-user" theme="white">
            ...
            {this.state.challenge_obj.map((item) => (
               <Cell before={<Avatar type="image" src="https://pp.userapi.com/c841025/v841025503/617f7/bkN1Def0s14.jpg" />} description="" asideContent={<Icon24MoreHorizontal fill="var(--accent)"/>}> asdas</Cell>
            ))}
            </List>
            }
